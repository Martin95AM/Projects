...
class Ventana():
    def __init__(self, window):
        ...
        self.observador_a = observador.ConcreteObservador(self.obj_crud)
    ...
    def alta_v(self):
        ...
        if self.obj_regex.check(
                        ...
                        self.limpiar()
                        self.obj_crud.notificar("Productos", "Producto registrado con éxito")
    ...
    def baja_v(self):
        ...
        self.obj_crud.notificar("Productos", "Producto eliminado con éxito")
    ...
    def modifica_v(self):
        ...
        if self.obj_regex.check(
                        ...
                        self.limpiar()
                        self.obj_crud.notificar("Productos", "Producto modificado con éxito")
